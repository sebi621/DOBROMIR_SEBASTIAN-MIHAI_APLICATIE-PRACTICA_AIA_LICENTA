<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OpenAuthProviders.ascx.cs" Inherits="School_Tickets.Account.OpenAuthProviders" %>

<div id="socialLoginList">
    <h4>Sau autentifica-te cu</h4>
    <hr />
